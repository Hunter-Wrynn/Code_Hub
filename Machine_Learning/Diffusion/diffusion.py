...
class Diffusion(nn.Module):
    def __init__(self,
        ...
        alphas_cumprod_prev=torch.cat([torch.ones(1,devices=kwargs["device"]),alphas_cumprod[:-1]])
        ...
        #计算均值
        self.register_buffer("sqrt_recip_alphas_cumpord",torch.sqrt(1.0 / alphas_cumprod))
